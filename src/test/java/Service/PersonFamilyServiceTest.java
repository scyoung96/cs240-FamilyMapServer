...
public class PersonFamilyServiceTest {
    ...
    PersonFamilyService testService;
    PersonFamilyRequest testRequest;
    PersonFamilyResult testResult;
    ...
    public void setUp() throws DataAccessException {
        ...
        testService = new PersonFamilyService();
    }
...
//        db.closeConnection(false);
    ...
    @Test
    public void PersonFamilyServicePass() throws DataAccessException {
        ...
        testRequest = new PersonFamilyRequest("testAuthtoken");
        testResult = testService.PersonFamilyService(testRequest);
    ...
    @Test
    public void PersonFamilyServiceFail() throws DataAccessException {
        // insert the info into the database
        testUserDao.create(testUser);
        testPersonDao.create(testPerson);
        testEventDao.create(testEvent);
        ...
        testRequest = new PersonFamilyRequest("wrongAuthtoken");
        testResult = testService.PersonFamilyService(testRequest);
