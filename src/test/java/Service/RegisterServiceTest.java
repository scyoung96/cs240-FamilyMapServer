...
//        db.closeConnection(false);
    ...
    public void RegisterServicePass() throws DataAccessException {
        ...
        testRequest = new RegisterRequest("testUsername", "testPassword", "testEmail", "testFirstName", "testLastName", "m");
        testResult = testService.RegisterService(testRequest);
    ...
    public void RegisterServiceFail() throws DataAccessException {
        ...
        testRequest = new RegisterRequest(null, null, null, null, null, null);
        testResult = testService.RegisterService(testRequest);
