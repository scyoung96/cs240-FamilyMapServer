...
public class PersonServiceTest {
    ...
    PersonRequest testRequest;
    PersonResult testResult;
    ...
    public void setUp() throws DataAccessException {
        ...
        testPerson = new Person("testPersonID", "testUsername", "testFirstName", "testLastName", "m", "testFatherID", "testMotherID", "testSpouseID");
...
//        db.closeConnection(false);
    ...
    public void PersonServicePass() throws DataAccessException {
        ...
        testRequest = new PersonRequest("testPersonID", "testAuthtoken");
        testResult = testService.PersonService(testRequest);
    ...
    public void PersonServiceFail() throws DataAccessException {
        ...
        testRequest = new PersonRequest("wrongPersonID", "wrongAuthtoken");
        testResult = testService.PersonService(testRequest);
