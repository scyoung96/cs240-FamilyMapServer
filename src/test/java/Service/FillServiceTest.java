...
public class FillServiceTest {
    ...
    FillService testService;
    FillRequest testRequest;
...
//        db.closeConnection(false);
    ...
    public void FillServicePass() throws DataAccessException {
        ...
        testRequest = new FillRequest("testUsername", 4);
        testResult = testService.FillService(testRequest);
    ...
    public void FillServiceFail() throws DataAccessException {
        ...
        testRequest = new FillRequest("wrongUsername", 4);
        testResult = testService.FillService(testRequest);
